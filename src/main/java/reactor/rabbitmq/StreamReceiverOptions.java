...
/**
 * Options for configuring a {@link StreamReceiver}.
 */
public class StreamReceiverOptions {
     ...
     */
    public StreamReceiverOptions environment(Environment environment) {
     ...
     * @return this options instance
     */
    public StreamReceiverOptions scheduler(Scheduler scheduler) {
